(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function vUh(module, __webpack_exports__, __webpack_require__) {
      ...
      function HomeComponent_ng_container_20_p_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomeComponent_ng_container_20_p_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomeComponent_ng_container_20_p_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomeComponent_ng_container_20_app_progress_bar_10_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function HomeComponent_ng_container_20_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_ng_container_20_Template_div_click_1_listener() {
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(firebaseService, sessionService, router) {
        ...
        _createClass(HomeComponent, [{
          ...
          key: "viewList",
          value: function viewList(listLocation) {
          ...
          key: "finishCreate",
          value: function finishCreate(user, newListName) {
            // add item to lists
            if (this.firebaseService.addList(user, newListName)) {
              this.errors.listName = ''; // update session user and list

              this.user = this.sessionService.getUser();
              this.lists = this.user.lists; // view list
      ...
      HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function HomeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_6_listener() {
              return ctx.cancelCreate();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_button_click_12_listener() {
              return ctx.finishCreate(ctx.user, ctx.newListName);
            });
    ...
    function IfdK(module, __webpack_exports__, __webpack_require__) {
      ...
      var SessionService = /*#__PURE__*/function () {
        ...
        _createClass(SessionService, [{
          ...
          value: function setUser(user) {
            ...
            sessionStorage.setItem("user", JSON.stringify(this.activeUser)); // this.cookieService.set('user', JSON.stringify(this.activeUser));
          }
        }, {
          key: "updateLists",
          value: function updateLists(item) {
          ...
          key: "updateSeledtedList",
          value: function updateSeledtedList(lists, selectdIndex) {
            this.activeUser.lists = lists;
            this.activeUser.selectedList = this.activeUser.lists[selectdIndex];
            sessionStorage.setItem("user", JSON.stringify(this.activeUser)); // this.cookieService.set('user', JSON.stringify(this.activeUser));
          }
        }, {
          key: "unsetSelectedList",
          value: function unsetSelectedList() {
      ...
      SessionService.ɵfac = function SessionService_Factory(t) {
        return new (t || SessionService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_cookie_service__WEBPACK_IMPORTED_MODULE_1__["CookieService"]));
      };
    ...
    function Z2Br(module, __webpack_exports__, __webpack_require__) {
      ...
      var FirebaseService = /*#__PURE__*/function () {
        function FirebaseService(firestore, sessionService) {
        ...
        _createClass(FirebaseService, [{
          ...
          value: function checkUsernameAvailability(newUsername) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var available, usernameRef;
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      available = false;
                      usernameRef = this.firestore.collection('usernameLookup').doc(newUsername);
                      _context.next = 4;
          ...
          value: function getUserInfo(user) {
            return this.firestore.collection('users', function (ref) {
              return ref.where('username', '==', user.username);
            }).snapshotChanges();
          }
        }, {
          ...
          key: "addList",
          value: function addList(user, listName) {
            ...
            var docRef = this.firestore.collection('users').doc(user.id);
            docRef.update({
          ...
          key: "addItem",
          value: function addItem(user, item) {
            var _this = this;

            var docRef = this.firestore.collection('users').doc(user.id);
            this.firestore.collection('users').doc(user.id).get().subscribe(function (res) {
              var localLists = res.get('lists');
              localLists[_this.sessionService.getSelectedIndex()].items = localLists[_this.sessionService.getSelectedIndex()].items.concat(item);
              docRef.update({
                lists: localLists
              });

              _this.sessionService.updateSeledtedList(localLists, _this.sessionService.getSelectedIndex());
            });
          }
        }]);
      ...
      FirebaseService.ɵfac = function FirebaseService_Factory(t) {
        return new (t || FirebaseService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_services_session_service__WEBPACK_IMPORTED_MODULE_4__["SessionService"]));
      };

      FirebaseService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_14__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], _components_progress_bar_progress_bar_component__WEBPACK_IMPORTED_MODULE_11__["ProgressBarComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_12__["HomeComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_13__["ListComponent"]],
    ...
    function uMRu(module, __webpack_exports__, __webpack_require__) {
      ...
      var _c1 = function _c1(a0, a1) {
        return {
          "item-action--light": a0,
          "item-action--secondary": a1
        };
      };

      function ListComponent_div_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ListComponent = /*#__PURE__*/function () {
        function ListComponent(firebaseService, sessionService, cookieService, router) {
        ...
        _createClass(ListComponent, [{
          ...
          key: "exitList",
          value: function exitList() {
            this.sessionService.unsetSelectedList();
            this.router.navigateByUrl('/home');
          }
        }, {
          key: "addItemModal",
          value: function addItemModal() {
            this.modal.nativeElement.style.display = 'flex';
          }
        }, {
          key: "cancelAddItem",
          value: function cancelAddItem() {
            this.modal.nativeElement.style.display = 'none';
          }
        }, {
          key: "createNewItem",
          value: function createNewItem(name) {
            var item = {
              "name": name,
              "completed": false
            };
      ...
      ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ListComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_Template_span_click_6_listener() {
              return ctx.cancelAddItem();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_Template_button_click_12_listener() {
              return ctx.createNewItem(ctx.newItemName);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_Template_div_click_30_listener() {
              return ctx.addItemModal();
            });
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgClass"]],
    ...
    function uSqO(module, __webpack_exports__, __webpack_require__) {
      ...
      ProgressBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 5,
        vars: 6,
        consts: [[1, "arsenal-progress-bar-wrapper"], [3, "ngClass"], ["class", "arsenal-progress-bar-section", 4, "ngFor", "ngForOf"], ["class", "arsenal-para a-mt--5 a-mb--0", 4, "ngIf"], [1, "arsenal-progress-bar-section"], [1, "arsenal-para", "a-mt--5", "a-mb--0"]],
    ...
    function vtpD(module, __webpack_exports__, __webpack_require__) {
      ...
      var bcryptjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! bcryptjs */
      "J5zx");
      /* harmony import */


      var bcryptjs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(bcryptjs__WEBPACK_IMPORTED_MODULE_1__);
      /* harmony import */
      ...
      var _components_progress_bar_progress_bar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../components/progress-bar/progress-bar.component */
      "uSqO");
      /* harmony import */
      ...
      function LoginComponent_h1_6_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "h1", 6);
      ...
      function LoginComponent_span_7_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_span_7_Template_span_click_0_listener() {
      ...
      function LoginComponent_div_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_8_Template_button_click_1_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_8_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r11);
      ...
      function LoginComponent_div_9_div_1_p_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function LoginComponent_div_9_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function LoginComponent_div_9_div_1_Template_input_ngModelChange_4_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_9_div_1_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r19);
      ...
      function LoginComponent_div_9_div_2_p_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 20);
      ...
      function LoginComponent_div_9_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function LoginComponent_div_9_div_2_Template_input_ngModelChange_7_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_9_div_2_Template_button_click_8_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r23);
      ...
      function LoginComponent_div_9_div_3_p_7_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 20);
      ...
      function LoginComponent_div_9_div_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function LoginComponent_div_9_div_3_Template_input_ngModelChange_4_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_9_div_3_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r27);

            var ctx_r28 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);

            return ctx_r28.next(3);
          });
      ...
      function LoginComponent_div_9_div_4_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_9_div_4_Template_button_click_3_listener() {
      ...
      function LoginComponent_div_10_p_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "p", 20);
      ...
      function LoginComponent_div_10_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function LoginComponent_div_10_Template_input_ngModelChange_4_listener($event) {
            ...
            return ctx_r32.lUsername = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function LoginComponent_div_10_Template_input_ngModelChange_7_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r33);

            var ctx_r34 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]();

            return ctx_r34.lPassword = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function LoginComponent_div_10_Template_button_click_8_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r33);
        ...
        _createClass(LoginComponent, [{
          ...
          value: function signUp() {
            ...
            this.firebaseService.createUser(this.newUser).then(function (res) {
              ...
              _this2.isCompletedSignUp = true;
            }, function (error) {
              _this2.errors.siteFail = "Looks like we had trouble creating your account :( Please try again later!";
            });
          }
        }, {
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.next = 2;
                      return this.firebaseService.checkUsernameAvailability(username).then(function (res) {
                        _this3.usernameAvailability = res;
                        console.log(_this3.usernameAvailability);

                        if (!_this3.usernameAvailability) {
                          _this3.usernameAvailabilityMsg = _this3.msgOptions.unavailable;
                        }
                      });
          ...
          value: function next(task) {
            if (task === 1) {
              ...
              var isEmailValid = this.validateEmail(this.sEmail);
          ...
          value: function login() {
            ...
            var pass;
            this.firebaseService.getUserInfo(this.returningUser).subscribe(function (res) {
              res.filter(function (x) {
                pass = x.payload.doc.get('password');
                _this4.returningUser.id = x.payload.doc.id;
                _this4.returningUser.lists = x.payload.doc.get('lists');
              });

              if (bcryptjs__WEBPACK_IMPORTED_MODULE_1__["compareSync"](_this4.lPassword, pass)) {
                _this4.sessionService.setUser(_this4.returningUser);

                _this4["continue"]();
              } else {
                _this4.clearFields();

                _this4.errors.failedLogin = 'Username or password is incorrect :( Try again?';
              }
            });
          }
        }]);
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        decls: 11,
        vars: 8,
        consts: [[1, "login"], [1, "arsenal-login-wrapper"], [1, "arsenal-header-wrap"], ["class", "heading--large", 4, "ngIf"], ["class", "material-icons arsenal-button--right a-fs--4em", 3, "click", 4, "ngIf"], [4, "ngIf"], [1, "heading--large"], [1, "material-icons", "arsenal-button--right", "a-fs--4em", 3, "click"], [1, "arsenal-button--primary", "a-mt--15", 3, "click"], [1, "arsenal-button--secondary", "a-mt--15", 3, "click"], ["class", "a-mb--20", 4, "ngIf"], [3, "stages"], [1, "a-mb--20"], [1, "arsenal-label", "a-mt--20", "a-mb--20"], [1, "arsenal-inline-input-wrapper"], ["type", "text", 1, "arsenal-inline-input", 3, "ngModel", "ngModelChange"], [1, "arsenal-inline-button", 3, "click"], ["class", "arsenal-para--error a-mt--10", 4, "ngIf"], [1, "arsenal-para", "a-mt--20"], [1, "arsenal-form-requirements", "a-mb--20"], [1, "arsenal-para--error", "a-mt--10"], [1, "a-fc--primary"], ["type", "password", 1, "arsenal-inline-input", 3, "ngModel", "ngModelChange"], [1, "arsenal-para", "a-mt--20", "a-mb--20"], [1, "arsenal-button--primary", "a-mt--15", "a-mb--20", 3, "click"], [1, "arsenal-label", "a-mt--20"], ["type", "text", "placeholder", "", 1, "arsenal-full-input", 3, "ngModel", "ngModelChange"], ["type", "password", "placeholder", "", 1, "arsenal-full-input", 3, "ngModel", "ngModelChange"], [1, "arsenal-button--primary", "a-mt--20", 3, "click"]],
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], _components_progress_bar_progress_bar_component__WEBPACK_IMPORTED_MODULE_7__["ProgressBarComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["NgModel"]],
